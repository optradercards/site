    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Configure the Shiny API auth credentials used by the exchange-rate
          refresh function and the shiny-sync container.
        </p>
      </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 text-sm text-blue-900 dark:text-blue-200">
        <p>
          <strong>Stored in Supabase Vault</strong> (encrypted at rest). The
          exchange-rate functions and the shiny-sync container retrieve the
          idToken server-side via{" "}
