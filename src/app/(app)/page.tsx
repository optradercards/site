      ...
      <section id="home" className="bg-gradient-to-br from-red-500 to-blue-500 text-white py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            The premier marketplace for One Piece Trading Card Game enthusiasts. Buy, sell, and trade cards with
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-base md:text-lg mb-6 text-gray-700 dark:text-gray-300 leading-relaxed">
              OP Trader is a specialized marketplace for One Piece Trading Card Game collectors. We provide a platform
              where enthusiasts can:
            </p>
            ...
            <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              Whether you&apos;re a seasoned collector or just starting your journey in the Grand Line, OP Trader is your
              trusted companion for all things One Piece TCG.
            </p>
          </div>
        </div>
      </section>
          ...
          >
            <div className="p-6 md:p-8">
              ...
              <p className="mb-3 text-base md:text-lg text-gray-700 dark:text-gray-300">
                ...
                <span
                  className={`${getRarityClass(selectedCard.rarity)} px-3 py-1 rounded-full text-xs font-bold text-white`}
                >
                  {selectedCard.rarity}
                </span>
              </p>
              {selectedCard.power && (
                <p className="mb-3 text-base md:text-lg text-gray-700 dark:text-gray-300">
                  <strong>Power:</strong> {selectedCard.power}
                </p>
              )}
