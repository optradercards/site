  ...
  if (!ticket) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/support/tickets" className="text-red-600 dark:text-red-400 hover:underline">
          Back to tickets
        </Link>
      </div>
    );
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
              ...
              <div className="space-y-4 mb-6">
                {messages.length === 0 ? (
                  <p className="text-gray-500 dark:text-gray-400 text-sm">No messages yet. We'll respond soon!</p>
                ) : (
                  messages.map((msg) => (
